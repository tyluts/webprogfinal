    ...
    <div class="row ">
        ...
        <div class="accordion-item dark-grey light-grey">
            ...
            <div class="accordion-body">
                ...
                <br>
                <a href="programs/coe/civil.php" class="btn bg-red text-white mt-2">Click Me</a>
            </div>
            </div>
        </div>
        <div class="accordion-item dark-grey light-grey ">
            ...
            <div class="accordion-body">
                ...
                <br>
                <a  href="programs/ccs/it.php" class="btn bg-red text-white mt-2">Click Me</a>            
            </div>
            </div>
        </div>
        <div class="accordion-item dark-grey light-grey">
            ...
            <div class="accordion-body">
                ...
                <br>
                <a  href="programs/cba/accountant.php" class="btn bg-red text-white mt-2">Click Me</a>            
            </div>
            </div>
        </div>
        </div>      
